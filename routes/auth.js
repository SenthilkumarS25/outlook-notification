...
import { getClientInfo } from '../helpers/tokenHelper';

export const authRouter = express.Router();

export async function createSubscription(token, clientInfo) {
...
authRouter.get('/callback', async (req, res, next) => {
  try {
    ...
    const subscriptionData = await createSubscription(token, getClientInfo(req.query.client_info));
    res.redirect(
